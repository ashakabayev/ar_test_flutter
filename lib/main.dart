import 'package:ar_flutter/local_and_web.dart';
import 'package:ar_flutter/obj_example.dart';
...
class ExampleList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final examples = [
      Example('Debug Options', 'Visualize feature points, planes and world coordinate system',
          () => Navigator.push(context, MaterialPageRoute(builder: (context) => DebugOptionsWidget()))),
      Example('Local & Online Objects', 'Place 3D objects from Flutter assets and the web into the scene',
          () => Navigator.push(context, MaterialPageRoute(builder: (context) => const LocalAndWebObjectsWidget()))),
      // Example('Anchors & Objects on Planes', 'Place 3D objects on detected planes using anchors',
      //     () => Navigator.push(context, MaterialPageRoute(builder: (context) => ObjectsOnPlanesWidget()))),
      // Example('Object Transformation Gestures', 'Rotate and Pan Objects',
      //     () => Navigator.push(context, MaterialPageRoute(builder: (context) => ObjectGesturesWidget()))),
      // Example('Screenshots', 'Place 3D objects on planes and take screenshots',
      //     () => Navigator.push(context, MaterialPageRoute(builder: (context) => ScreenshotWidget()))),
      // Example('Cloud Anchors', 'Place and retrieve 3D objects using the Google Cloud Anchor API',
