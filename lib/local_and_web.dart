          ...
          Align(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.end, children: [
                Row(
                  ...
                  children: [
                    ElevatedButton(
                        onPressed: onFileSystemObjectAtOriginButtonPressed, child: const Text("Add/Remove Filesystem\nObject at Origin")),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    ...
                    ElevatedButton(onPressed: onWebObjectAtOriginButtonPressed, child: Text("Add/Remove Web\nObject at Origin")),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    ...
                    ElevatedButton(onPressed: onWebObjectShuffleButtonPressed, child: Text("Shuffle Web\nObject at Origin")),
                  ],
                )
              ]))
        ]));
  ...
  Future<void> onLocalObjectAtOriginButtonPressed() async {
    if (this.localObjectNode != null) {
      ...
      var newNode = ARNode(
          ...
          uri: "models/Chicken_01/Chicken_01.gltf", //'models/Chicken_01.gltf',
  ...
  Future<void> onWebObjectAtOriginButtonPressed() async {
    if (this.webObjectNode != null) {
      ...
      var newNode = ARNode(
          ...
          uri: 'https://skfb.ly/oqvuq', //"https://github.com/KhronosGroup/glTF-Sample-Models/raw/master/2.0/Duck/glTF-Binary/Duck.glb",
          scale: Vector3(0.2, 0.2, 0.2));
